                ...
                <Menu.Item>
                    <Dropdown item text='Frontend Integration'>
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Divider/>
                            <Dropdown.Item as={Link} to='/purchaseList/add' text='Add Purchase List'/>
                            <Dropdown.Item as={Link} to='/purchaseList/list' text='List Purchase Lists'/>
                            <Dropdown.Divider/>
                            <Dropdown.Item as={Link} to='/recipe/add' text='Add Recipe'/>
                            <Dropdown.Item as={Link} to='/recipe/list' text='List Recipe'/>
                        </Dropdown.Menu>
                    </Dropdown>
                </Menu.Item>
            </Menu>
